...
//    float kernel[] = {0, 1, 0, 1, 1, 1, 0, 1, 0};

//    float kernel_[] = {-1, 0, 1, -1, 0, 1, -1, 0, 1};
//    float kernel_[] = {1, 0, -1};
    float kernel_[] = {-0.5, 0, 0.5};
    std::cout << img << std::endl;
    auto values = static_cast<uint8_t *>(init("uint8_t", img.getChannels()));
...
//    Image luminance = img.luminance(0,0,1);
//    printf("okankef\n");

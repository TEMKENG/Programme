...
Die Eingangsschicht stellt die Eingangsdaten dar. Hier müssen die Eingangsdaten dreidimensional sein.Also die Eingangsdaten von \ac{CNN}  haben immer die folgende Form $ W$ x $H$ x $D $ wobei $ (W, H) $ der räumlichen Dimension und $ D $ die Tiefe der Daten entspricht. Z.B  $ 100$ x $100 $ x $3 $ für ein RGB-Bild und $ 224x224x1 $ für ein Graustufenbild.
...
%\subsubsection{Depthwise Separable Convolution Layer}
Kombination von Depthwise und Pointwise Convolution. 
Verringerung der Anzahl von Parametern und Berechnungen.

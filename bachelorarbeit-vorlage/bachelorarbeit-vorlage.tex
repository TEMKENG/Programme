...
Aus der Abbildung(\ref{fig:Lernrate}) stellt man zuerst fest, dass die Verwendung verschiedener Lernrate zu unterscheiden Ergebnissen führt und Je höher die Lernrate, desto mehr Schwankungen gibt es.
...
\begin{figure}[h]
	...
	\begin{center}
		\begin{tabular}{r@{: }l r@{: }l}
			...
			$ 1\_ $& Lernrate$ =0.001 $ &	$ 2\_ $ & Lernrate$ =0.005 $\\  \textcolor{purple}{$\longrightarrow$} & Forward-Pass  &
			\textcolor{blue}{$\longrightarrow$} & Fehlerfunktion
		\end{tabular}
...
\subparagraph{Depthwise Separable Convolution} \label{DSC}
...
\subsection{ Besondere Konvolution Neuronale Netzwerke}

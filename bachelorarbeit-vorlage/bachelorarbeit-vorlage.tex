...
\end{center}
\begin{itemize}
	\item Wegen der Annäherung gehen die Daten immer verloren
	\item Vektoren aus kleiner Dimension fordern weniger Speicherplatz, durch Matrixoperation wird sich die kleine der Originale Vektor annähert
	\item Vector Quantisierung( SVD)  in \ac{FCL}\quad siehe Numerik Vorlesung  $ (blatt13\_sol.py) $
	\item  Low-bit Quantisierung
\end{itemize}
\begin{itemize}
	\item  Der Speicherbedarf für ein Low-Bit-Präzisionsmodell kann ebenso wie der Stromverbrauch erheblich reduziert werden.
	\item Kernel weise Quantisierung

...
\paragraph{Algorithmen zur Optimierung des Gradientenabstiegsverfahren:	Optimizer}
\subparagraph{Adaptive Gradient Algorithm (AdaGrad):}
...
\subparagraph{\textit{Root Mean Square Propagation:}RMSProp}
...
\subparagraph{Adam \textit{Adaptive Moment Estimation:Adam}}

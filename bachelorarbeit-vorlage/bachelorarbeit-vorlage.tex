...
\paragraph{Warum wird Gradientenverfahren gebraucht}.\\
...
\paragraph{Funktionieren von Gradientenverfahren }.\\
...
\paragraph{Type von Gradientenverfahren}.\\
...
\begin{center}
	...
	\end{tabular}
\end{center}
\subparagraph{\textbf{Stochastic Gradient Descent:}\textit{SGD}}.\\
...
\subparagraph{\textbf{Batch Gradient Descent:}\textit{BGD}} .\\
...
\subparagraph{\textbf{Mini-batch Stochastic Gradient Descent:}\textit{MSGD}}.\\
...
AlexNet kann aufgrund seiner Größe($\sim240MB$) nicht immer auf Systemen mit begrenztem Speicherplatz eingesetzt werden, deshalb ist man ständig auf der Suche nach neuen Architekturen, die weniger Parameter und Speicherplatz brauchen und  gleichzeitig die Ergebnisse auf der Stand der Technik erreichen oder übertreffen. Es ist sicherlich  in diesem Zusammenhang, dass viele neue effiziente Modelle wie $ SqueezeNet $, $ Xception $ und $ MobileNet $ entstanden.\\

kleinere \acsp{CNN}-Architekturen weisen mehrere Vorteile auf wie \\
Kurze Trainingszeit\\


 \subsection{SqueezeNet}
 SqueezeNet\cite{SqueezeNet} mit seinem Feuermodul(\textit{fire module})(siehe Abbildung\ref{fig:fire_module}) erreicht die Genauigkeit von AlexNet mit 50x weniger Parametern und  einer Größe kleiner als $ 0.5MB$. 
 \begin{figure}[h]
 	\centering
...
\end{figure}
%verzögerte Downsampling zu einer höheren Genauigkeit von classiﬁcation 

...
\begin{abstract}
	...
	\begin{enumerate}
	\item Ein CNN(\textit{TemkiNet}) entwickelt, das :
	\begin{itemize}
		\item Zu wenige Parameter verwendet.
		\item Gute Inferenz hat.
	\end{itemize}
	\item CNN Vergleich
		\begin{itemize}
			\item AlexNet.
			...
			\item TemkiNet.
		\end{itemize}
	\item Methoden und Hyperparameter zur Verbesserung der Netzwerkleistung.
		\begin{itemize}
			...
			\item Lernrate.
			\item Dropout.
			\item Anzahl der Neuronen pro Schichten.
		\end{itemize}
	\item CNN komprimieren.
		\begin{itemize}
			\item Pruning.
			\item Quantisierung.
		\end{itemize}
	\item Reduzierung der Trainingszeit.
		\begin{itemize}
			\item neu LeaningRateScheduler.
			\item Tranfer Leaning mit verschiedene Bildgröße.
			\item neue Trainingsart.
		\end{itemize}
\end{enumerate}
\centering	\textbf{la vie est belle}
...
\begin{table}[h!]
	...
	$ (100, 100, 3) $
		\begin{tabular}{*{3}{|c}|}
			\hline
			Prune  & Genauigkeit & Modellgröße \\ \hline
			00\%	& 67.08 \%&  16.9 MB  \\ \hline
			10\%	& 67.01 \%&  5.8 MB   \\ \hline
			20\%	& 64.45 \%&  5.8 MB 	\\ \hline
...
\begin{table}[h!]
	...
	\begin{tabular}{*{3}{|c}|m	{2cm}|}
		\hline
		\#Bits  & Genauigkeit & Modellgröße & Inferenzzeit (Image/s) \\ \hline
		32	& 67.69 \%&  21.2 MB  & 1\\ \hline
		16	& 66.99 \%&  5.4  MB  & 2\\ \hline
		8	& 67.20 \%&  5.4  MB  &	9\\ \hline
